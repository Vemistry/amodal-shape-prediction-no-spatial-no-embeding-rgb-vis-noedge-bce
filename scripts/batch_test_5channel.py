"""
===================================================================================
BATCH TEST - Visualize các kênh đầu vào và đầu ra của mô hình
===================================================================================
Script để kiểm tra đầu vào/đầu ra của mô hình.

Hiển thị:
1. Ảnh RGB gốc (3 kênh)
2. Visible mask (kênh 4)
3. Dự đoán Amodal từ mô hình
4. Đáp án thực tế
...
def batch_test_4channel():
    """
    Chạy test trên batch 16 ảnh và hiển thị kết quả.
    """
    # ─────────────────────────────────────────────────────────────
    # KHỞI ĐỘNG
    # ─────────────────────────────────────────────────────────────
    ...
    # NẠP MÔ HÌNH
    # ─────────────────────────────────────────────────────────────
    model = AmodalSwinUNet().to(DEVICE) # Model này nhận 4 kênh
    ...
    axes[1].set_title("Kênh 4 (Visible Mask)", fontsize=14, fontweight='bold')
    axes[1].axis('off')

    # Cột 3: Dự đoán
    axes[2].imshow(grid_pred[0], cmap='gray')
    axes[2].set_title("Dự Đoán Amodal", fontsize=14, fontweight='bold', color='blue')
    axes[2].axis('off')
